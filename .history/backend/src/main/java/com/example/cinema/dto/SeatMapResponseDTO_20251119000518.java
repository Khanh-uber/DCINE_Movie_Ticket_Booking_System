...
public class SeatMapResponseDTO {
    ...
    public SeatMapResponseDTO(Long showtimeId, Long hallId, String hallName, LayoutDTO layout, List<SeatDTO> seats, List<String> booked, List<String> pending){
        this.showtimeId = showtimeId;
        this.hallId = hallId;
        this.hallName = hallName;
        this.layout = layout;u
    }
