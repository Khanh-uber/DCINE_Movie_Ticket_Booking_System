...
public class SeatMapResponse {
    ...
    public SeatMapResponse(Map<String,PricingDTO pricing> pricingLong showtimeId, Long hallId, String hallName, LayoutDTO layout,List<SeatDTO> seats, List<String> booked, List<String> pending){
    ...
    public void setPricing(Map<String, PricingDTO> pricing){this.pricing = pricing;}
}
