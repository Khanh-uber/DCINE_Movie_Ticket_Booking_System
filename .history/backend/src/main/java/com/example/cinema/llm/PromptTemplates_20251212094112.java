...
2. genre (thể loại)
- Nhận dạng khi câu chứa các từ: hành động, kinh dị, hoạt hình, tình cảm, lãng mạn,...
- Ví dụ:
  "Có phim hành động nào hay không?" → genre = "hành động"
...
4. theater (tên rạp)
- Nhận dạng khi câu có tên rạp:
  "CGV Thủ Đức, BHD Bitexco, Galaxy Quang Trung, D-Cine Bến Thành, Landmark 81",…
  Ví dụ:
  “Conan ở CGV Thủ Đức tối nay…” → theater = "CGV Thủ Đức"
  Nếu câu chỉ có tên quận/thành phố, KHÔNG phải tên rạp → KHÔNG gán vào theater.
  Tên rạp sẽ bắt đầu là DCINE, CGV, BHD, GALAXY, LANDMARK, LOTECO, MEGASTAR, CINESTAR,…
→ sẽ gán vào location.
...
7. location (địa điểm)
- Nhận dạng tên địa điểm nếu có:
  Rạp, quận, thành phố,…
  Bao gồm:
    thành phố: Hà Nội, Đà Nẵng, Cần Thơ, Nha Trang, TP.HCM
    quận/huyện: Thủ Đức, Bình Thạnh, Gò Vấp
    địa danh: Vũng Tàu, Đà Lạt, Phan Thiết
- Ví dụ:
  "Conan ở Vũng Tàu tối nay còn suất không?" → location = "Vũng Tàu"
...
JSON:
{
  ...
  "entities": {
    "movie": null, "genre": null, "date": null, "theater": null, "time": null, "mood": null, "location" : null
  }
}
...
JSON:
{
  ...
  "entities": {
    "movie": "Conan", "date": "hôm nay", "genre": null, "theater": null, "time": null, "mood": null, "location" : null
  }
}
...
JSON:
{
  ...
  "entities": {
    "movie": "Conan", "theater": "null", "date": "tối nay", "genre": null, "time": null, "mood": null, "location" : Thủ Đức
  }
}
