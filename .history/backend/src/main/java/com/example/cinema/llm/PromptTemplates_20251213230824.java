...
TIME:
  ...
  → BẮT BUỘC gán time bằng từ chỉ buổi đó
  - Nếu người dùng nói giờ cụ thể:
  "8h", "8 giờ", "21h", "21:00", "9 rưỡi"
  → chuẩn hoá về HH:mm (24h) và gán vào time.
  - Nếu câu có cả buổi và giờ cụ thể
  → ưu tiên GIỜ CỤ THỂ cho time.
  - Nếu từ "tối" (hoặc sáng/chiều/khuya) xuất hiện trong câu hỏi
  VÀ câu hỏi có liên quan đến phim, chiếu phim, suất chiếu, rạp phim
  (ví dụ có các từ: phim, chiếu, suất, rạp)
  → BẮT BUỘC gán entity time = "tối".
==========================
