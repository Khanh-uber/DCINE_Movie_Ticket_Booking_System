...
TIME:
Entity time dùng để biểu diễn buổi hoặc giờ chiếu.

Nếu người dùng nói thời gian theo buổi (sáng, trưa, chiều, tối, khuya) thì gán đúng từ đó vào time.

Nếu người dùng nói cụm có buổi kèm ngày (tối nay, sáng mai, chiều hôm nay) thì tách: date là phần ngày (nay, mai, hôm nay, ngày mai) và time là phần buổi (sáng, chiều, tối).

Nếu người dùng nói giờ cụ thể (8h, 8 giờ, 21h, 21:00, 9 rưỡi) thì chuẩn hoá về định dạng HH:mm (24h) và gán vào time.

Nếu câu hỏi có cả buổi và giờ cụ thể thì ưu tiên giờ cụ thể cho time.

Nếu không có thông tin thời gian thì time = null.

Không tự suy đoán thời gian.

Không gán toàn bộ cụm “tối nay”, “sáng mai” vào time; time chỉ chứa buổi hoặc giờ, không chứa ngày.
