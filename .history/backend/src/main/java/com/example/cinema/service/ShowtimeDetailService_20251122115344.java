...
public class ShowtimeDetailService {
    ...
    public ShowtimeDetailResponse getShowtimeDetail(Long id){
        ...
        stMovie.setGenres(movieRepository.findGenresByMovieId(movieId));
        dto.setDirector(movieRepository.findDirector(movieId));
        dto.setCast(movieRepository.findCast(movieId));
