...
public class ChatService {
    ...
    String instruction = """
        Đây là danh sách phim sắp chiếu của D-Cine.
        Hãy viết câu trả lời ngắn gọn và thân thiện:
        - Mở đầu bằng một câu vui vẻ thông báo về các phim sắp chiếu.
        - KHÔNG liệt kê tên phim hoặc mô tả chi tiết phim, vì danh sách sẽ được hiển thị phía dưới giao diện.
        - Cuối câu hãy gợi ý một vài câu hỏi tiếp theo cho người dùng.
        Giữ giọng văn tự nhiên, đùa giỡn một chút, và ngắn gọn.
    """;
    ...
    private ChatResponse handleSuitableMovies(IntentResult.Entities entities){
        List<String> moods = entities.getMood();
