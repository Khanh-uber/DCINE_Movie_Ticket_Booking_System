...
public class ChatService {
    ...
    //         String instruction = """
    //             Người dùng muốn xem lịch chiếu nhưng chưa nói tên phim.
    //             Hãy hỏi lại thật thân thiện và tự nhiên, có thể đùa nhẹ.
    ...
    //     if (theaterText == null || theaterText.isBlank()){
    //         String instruction = """
    //             Người dùng muốn xem lịch chiếu nhưng chưa nói tên rạp.
    //             Hãy hỏi lại thật thân thiện và tự nhiên, có thể đùa nhẹ.
    //             "Bạn muốn xem lịch chiếu ở rạp nào?"
    //         """;
    //         String reply = replyService.reply(
    //                 "hoi_lich_chieu",
    //                 "{}",
    ...
    //     if (date == null){
    //         String instruction = """
    //             Người dùng muốn xem lịch chiếu nhưng chưa nói ngày cụ thể.
    //             Hãy hỏi lại thật thân thiện và tự nhiên, có thể đùa nhẹ.
    //             "Bạn muốn xem lịch chiếu vào ngày nào?"
    //         """;
    //         String reply = replyService.reply(
    //                 "hoi_lich_chieu",
    //                 "{}",
