...
public interface ShowTimeRepository extends JpaRepository<Showtime, Long>{ 
    ...
    @Query(value = """
                        ...
                        AND s.start_at > NOW() + INTERVAL 10 MINUTE
    ...
    @Query(value = """
        ...
        """, nativeQuery = true)
    Map<String, Object> findShowtimeDetail(@Param("id") Long id);
    ...
    @Query(value="""
            ...
            from showtime s
            join movie on m.movie_id = s.movie_id
            where s.showtime_id = :showtimeId
            """, nativeQuery = true)
    Map<String, Object> getShowtimeMeta(@Param("showtimeId") Long showtimeId);


    Map<String, Object> getTicketInfo 
}
