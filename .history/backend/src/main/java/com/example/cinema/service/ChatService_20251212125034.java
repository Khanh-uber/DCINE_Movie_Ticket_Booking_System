...
public class ChatService {
    ...
    if (movies == null || movies.isEmpty()) {
        ...
        String reply = llmReplyService.reply(
                "hoi_phim_sap_chieu",
                context,
                instruction
        );
    ...
    String instruction = """
        ...
        - Tóm tắt 3–5 phim nổi bật nhất (dựa vào context).
        - Nếu có ngày khởi chiếu thì nhắc đến.
        - Không liệt kê toàn bộ nếu quá dài.
        - Cuối câu hãy gợi ý: "Bạn muốn xem chi tiết phim nào?"
    """;
