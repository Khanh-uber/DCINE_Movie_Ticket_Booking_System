...
public class ChatService {
    ...
    public ChatService(LLMService llmService, ShowtimeService showtimeService, MovieService movieService, ReplyHelper replyHelper) {
    ...
    private ChatResponse handleNowShowing(){
        ...
        String reply = replyService.reply(
            "hoi_phim_dang_chieu",
            context,
            "Hãy giới thiệu danh sách phim đang chiếu theo giọng vui vẻ, tự nhiên."
        );
