...
public class BookingService {
    ...
    public BookingService(SeatRepository seatRepo, ShowTimeRepository showtimeRepo, BookingSeatRepository bookingSeatRepo, 
        SeatLayoutRepository seatLayoutRepo, SeatTypeRepository seatTypeRepo, BookingRepository bookingRepo, RedisSeatService redisSeatService){
    ...
    public BookingResponse createBooking(Long showtimeId, List<BookingRequest.SeatRequest> requestedSeats, HttpSession session){
