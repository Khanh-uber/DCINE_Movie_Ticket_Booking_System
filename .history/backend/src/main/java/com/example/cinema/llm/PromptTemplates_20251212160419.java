...
ENTITY TRÍCH XUẤT
========================
movie → tên phim (không suy đoán) Nếu câu bắt đầu bằng "phim" + <cụm danh từ>    → phải gán vào movie, KHÔNG được gán vào genre.
...
MOVIE:
- Nếu có từ "phim <tên>" → trích tên phim.
- Nếu câu bắt đầu bằng tên phim → trích tên đó.
- Không đoán phim nếu user không nói rõ.
