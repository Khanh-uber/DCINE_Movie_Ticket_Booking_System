...
public class ShowtimeDetailService {
    ...
    public ShowtimeDetailResponse getShowtimeDetail(Long id){
        ...
        stMpvie.setDuration(mv.getDurationMin());
        dto.setLanguage(mv.getLanguage());
        dto.setReleaseDate(mv.getReleaseDate() != null ? mv.getReleaseDate().toString() : null);
        dto.setSynopsis(mv.getSynopsis());
