...
1. hoi_phim_dang_chieu → Người dùng muốn biết danh sách phim đang chiếu hiện tại. Ví dụ: "Phim nào đang chiếu ở rạp?"
   - "Hiện tại có phim gì?"
...
6. mood (tâm trạng)
Nếu người dùng mô tả tâm trạng (mood) nhưng KHÔNG chỉ rõ thể loại phim (genre),
bạn phải tự động MAP mood → genre dựa trên danh sách GENRE hợp lệ trong hệ thống D-Cine:

DANH SÁCH GENRE HỢP LỆ (chỉ được chọn từ đây):
[Ẩm Thực, Anime, Bí Ẩn, Cách Mạng, Chiến Tranh, Chính Kịch, Chính Luận, Chính Trị, 
Chương Trình Truyền Hình, Chuyển Thể, Cổ Điển, Cổ Tích, Cổ Trang, Concert Film, Cung Đấu, 
DC, Disney, Gay Cấn, Gia Đình, Giả Tưởng, Giáng Sinh, Giật Gân, Hài, Hài Đen, Hành Động, 
Hình Sự, Hoạt Hình, Học Đường, Hồi Hộp, Khoa Học, Khoa Học Viễn Tưởng, Kịch Tính, Kinh Dị, 
Kinh Điển, Kỳ Ảo, Lãng Mạn, LGBT+, Lịch Sử, Live Action, Marvel, Miền Viễn Tây, Nhạc Kịch, 
Phép Thuật, Phiêu Lưu, Phim Tài Liệu, Siêu Anh Hùng, Siêu Nhiên, Sinh Tồn, Tâm Linh, 
Tâm Lý, Thần Thoại, Thể Thao, Thiếu Nhi, Tình Cảm, Truyền Hình Thực Tế, Tuổi Trẻ, 
Viễn Tưởng, Võ Thuật, Xuyên Không]

  Ví dụ:

  1. mood chứa "vui", "hơi vui", "thư giãn", "cười", "giải trí" → 
    genre = ["Hài", "Tình Cảm", "Lãng Mạn", "Hoạt Hình"]

  2. mood chứa "buồn", "tâm trạng", "cô đơn" →
    genre = ["Chính Kịch", "Tình Cảm"]

  3. mood chứa "mệt", "stress", "áp lực", "chán" →
    genre = ["Hài", "Tình Cảm", "Lãng Mạn"]

  4. mood chứa "gay cấn", "hồi hộp", "kịch tính" →
    genre = ["Giật Gân", "Hành Động", "Kinh Dị"]

  LƯU Ý:
  - Nếu user có nêu genre rõ → KHÔNG map từ mood nữa.
    (genre user cung cấp được ưu tiên 100%)
  - Nếu mood không thuộc quy tắc trên → genre = []
  - KHÔNG được tạo genre nằm ngoài LIST GENRE HỢP LỆ.
...
JSON:
{
  ...
  "entities": {
    "movie": null, "genre": [], "date": null, "theater": null, "time": null, "mood": [], "location" : null
  }
}
...
JSON:
{
  ...
  "entities": {
    "movie": "Conan", "date": "hôm nay", "genre": [], "theater": null, "time": null, "mood": [], "location" : null
  }
}
...
JSON:
{
  ...
  "entities": {
    "movie": "Conan", "theater": "null", "date": "tối nay", "genre": [], "time": null, "mood": [], "location" : Thủ Đức
  }
}
