...
public class SeatMapResponse {
    ...
    public SeatMapResponse(Map<String,PricingDTO> pricingLong showtimeId, Long hallId, String hallName, LayoutDTO layout,List<SeatDTO> seats, List<String> booked, List<String> pending){
