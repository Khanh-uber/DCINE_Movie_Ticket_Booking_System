...
public class ShowtimeService {
    ...
    public getShowtimesByMovieAndDate(Long movieId, LocalDate date) {
        return repo.findShowtimesByMovieAndDate(movieId, date.atStartOfDay(), date.plusDays(1).atStartOfDay());
    }
