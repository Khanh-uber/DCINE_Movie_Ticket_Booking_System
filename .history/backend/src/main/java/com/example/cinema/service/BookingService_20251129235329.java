...
public class BookingService {
    ...
    public BookingResponse createBooking(Long showtimeId, Long accountId, BookingRequest.SeatRequest req){
        ...
        for (String code : codes) {
            ...
            Map<Object, Object> typeMap = redisSeatService.getSeatTypes(showtimeId, accountId);
            String type = "adult";  // default

            if (typeMap.containsKey(code)) {
                type = typeMap.get(code).toString();
}
            total += finalPrice;
