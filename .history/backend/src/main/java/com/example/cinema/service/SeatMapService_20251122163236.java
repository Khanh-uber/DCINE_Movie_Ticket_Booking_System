...
public class SeatMapService {
    ...
    public SeatMapService(RedisSeatService redisSeatSerBookingSeatRepository bookingSeatRepo,SeatRepository seatRepo,ShowTimeRepository showtimeRepo,SeatLayoutRepository seatLayoutRepo){
    ...
    public SeatMapResponse getSeatMap(Long showtimeId){
        ...
        for (Seat s : seats){
            ...
            item.setZone(zone);
            // status
            if (booked.contains(code)) item.setStatus("booked");
            else if (held.contains(code)) item.setStatus("held");
