...
public class PricingService {
    ...
    public PricingResponse preview(Long showtimeId, PricingRequest req){
        ...
        List<String> rows = (List<String>) layout.get("rows");
        Integer cols = (Integer) layout.get("columns");
        List<Integer> aislesAfter = (List<Integer>) layout.get("blocks");
