...
public class ShowtimeSeatMapResponse {
    ...
    // ===== PRICING =====
    private PricingBlock pricing;

    public static class PricingBlock {
    ...
    public PricingBlock getPricing() { return pricing; }
    public void setPricing(PricingBlock pricing) { this.pricing = pricing; }
}
