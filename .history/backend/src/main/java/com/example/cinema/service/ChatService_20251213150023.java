...
public class ChatService {
    ...
    public ChatResponse handleFullShowtime(IntentResult.Entities e) {
        ...
        2. Tuyệt đối KHÔNG DÙNG từ "Xin lỗi" hay "lịch sự". Thay bằng cụm từ thể hiện sự tiếc nuối thân mật: "Ái chà, hơi buồn nha!" hoặc "Tiếc quá!".
...
3. Kêu gọi hành động: Kết thúc bằng lời rủ rê và gợi ý LỌC hoặc XEM TIẾP.
   - Gợi ý 1: "Chọn rạp bạn muốn quẩy ngay!"
   - Gợi ý 2: "Hay là tui lọc suất tối (từ 18h trở đi) cho bạn xõa nhé?"
        """;
