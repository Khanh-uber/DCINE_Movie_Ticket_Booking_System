...
public class ConcessionController {
    ...
    public ResponseEntity<ConcessionResponse> getSummary() {
        ...
        // Sau này thay bằng accountId từ session
        // Long accountId = 1L;
        Long accountId = getAccount
        ConcessionResponse response = concessionService.loadSummary();
    ...
    public ResponseEntity<ConcessionResponse> updateCart(
        ...
        ConcessionResponse res = concessionService.updateCart(req);
