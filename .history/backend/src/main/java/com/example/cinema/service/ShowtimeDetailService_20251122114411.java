...
public class ShowtimeDetailService {
    ...
    public ShowtimeDetailResponse getShowtimeDetail(Long id){
        ...
        movie.setId("mv-" + mvRow.get("movie_id"));
        movie.setTitle((String) mvRow.get("title"));
        movie.setOriginalTitle((String) mvRow.get("original_title"));
        movie.setPosterUrl((String) mvRow.get("poster_url"));
        movie.setBackdropUrl((String) mvRow.get("backdrop_url"));
        movie.setTrailerUrl((String) mvRow.get("trailer_url"));
    }
}
