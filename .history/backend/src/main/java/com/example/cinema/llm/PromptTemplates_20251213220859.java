...
- Nếu người dùng nói thời gian theo BUỔI:
  "sáng", "trưa", "chiều", "tối", "khuya"
  → gán entity time = đúng từ chỉ buổi đó.
- Nếu người dùng nói cụm như:
  "tối nay", "sáng mai", "chiều hôm nay"
    + time = "tối" / "sáng" / "chiều"
- Nếu người dùng nói GIỜ CỤ THỂ:
  "8h", "8 giờ", "21h", "21:00", "9 rưỡi"
  → chuẩn hoá về HH:mm (24h)
  → gán vào entity time.
- Nếu câu hỏi có CẢ buổi và giờ cụ thể:
  → ƯU TIÊN GIỜ CỤ THỂ cho entity time.
- Nếu không có thông tin thời gian:
  → time = null.
- KHÔNG gán toàn bộ "tối nay", "sáng mai" vào time.
  Time chỉ chứa BUỔI hoặc GIỜ, KHÔNG chứa ngày.
...
User: "Tối nay phim Conan chiếu mấy giờ?"
JSON:
{
