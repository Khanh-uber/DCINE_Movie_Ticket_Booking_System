...
public class ValidateConflictService {
    ...
    public ValidateConflictService(SeatRepository seatRepo, ShowTimeRepository showtimeRepo, BookingSeatRepository bookingSeatRepo){
    ...
    public List<String> validateSeatConflicts(Long showtimeId, List<String> requestedSeats){
        ...
        List<String> conflictSeats = bookingSeatRepo.findConflictedSeatCodes(showtimeId, seatIds);
    }
