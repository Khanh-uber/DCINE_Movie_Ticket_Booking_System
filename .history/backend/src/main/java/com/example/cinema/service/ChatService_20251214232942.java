...
public class ChatService {
    ...
    public ChatResponse handleFullShowtime(IntentResult.Entities e) {
        ...
        // =====================================================
        TheaterDTO theater = theaterLookupService.findTheater(theaterText, locationte);
        ...
        String instruction = """
            ...
            YÊU CẦU NỘI DUNG:
            1. Mở đầu nhiệt tình: Xác nhận tên phim (từ Context.movie) và ngày chiếu (từ Context.date) bằng giọng điệu phấn khích.
            ...
            3. Kêu gọi hành động: Kết thúc bằng lời rủ rê và gợi ý.
