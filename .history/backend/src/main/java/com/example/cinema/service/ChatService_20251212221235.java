...
public class ChatService {
    ...
    public ChatService(LLMService llmService, ShowtimeService showtimeService, MovieService movieService, ReplyHelper replyHelper, LLMReplyService replyService, MovieLookupService movieLookupService, DateParserService dateParserService ) {
    ...
    private ChatResponse handleSuatTheoPhim(IntentResult.Entities e) {
    ...
    List<ShowtimeDTO> showtimes = showtimeService.getShowtimesByMovieAndDate(movie.getId(), date);
    ...
    if (showtimes == null || showtimes.isEmpty()) {
        ...
        String instruction = """
            Không có suất chiếu nào của phim trong thời gian mà .
            Hãy trả lời thân thiện:
    ...
    String instruction = """
        Hãy viết câu trả lời thật thân thiện cho người dùng:
        - Nói rằng phim có suất chiếu trong ngày yêu cầu.
        - KHÔNG liệt kê danh sách suất chiếu (vì FE sẽ hiển thị bên dưới).
        - Đùa nhẹ 1–2 câu để câu trả lời vui hơn.
        - Ngắn gọn.
    """;
    ...
    // 7. FE sẽ hiển thị showtimes trong data
