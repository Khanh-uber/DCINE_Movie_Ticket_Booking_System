...
public class ProfileService {
    ...
    public ProfileResponse getProfile(Long accountId) {
        ...
        u.setTotalSpent(acc.get("total_amounts "));
        ...
        res.setTiers(List.of(
                new ProfileResponse.MembershipTierDTO("Standard", 0L),
                new ProfileResponse.MembershipTierDTO("Silver", 1_000_000L),
                new ProfileResponse.MembershipTierDTO("Gold", 3_000_000L),
                new ProfileResponse.MembershipTierDTO("Platinum", 10_000_000L)
        ));
