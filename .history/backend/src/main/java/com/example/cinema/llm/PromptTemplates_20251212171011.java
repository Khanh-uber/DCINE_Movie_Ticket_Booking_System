...
Ví dụ:
- "phim mai có hay không?"
- "nói mình nghe phim inside out 2 có hay không?"
- "conan dở hay hay?"
- "review phim venom 3"
6. hoi_phim_phu_hop → gợi ý phim theo tâm trạng
7. hoi_suat_theo_phim → hỏi suất chiếu theo phim
8. hoi_suat_theo_rap → hỏi suất chiếu theo rạp
9. hoi_suat_theo_ngay → hỏi phim/suất theo ngày
10. hoi_lich_chieu → câu có từ 2 entity trở lên (phim + ngày + rạp)
...
MOVIE:
- Nếu câu chứa từ “phim”, bạn PHẢI lấy toàn bộ cụm từ sau từ “phim” 
  cho đến trước từ nghi vấn như: 
  ["có", "còn", "hay", "không", "khum", "hả", "à", "?" ] 
- KHÔNG được rút gọn cụm, KHÔNG được loại bỏ bất kỳ từ nào.
- Lấy nguyên văn, kể cả khi không chắc đó là tên phim thật.
