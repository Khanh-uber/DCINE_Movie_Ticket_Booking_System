...
public class ChatService {
    ...
    private ChatResponse handleByGenre(Map<String, String> entities){
        List<String> genres = Arrays.asList(entities.get("genre").split(","));
        ...
        if (movies.isEmpty()) {
            return new ChatResponse("Hiện tại không có phim nào thuộc thể loại " + genre + ".");
        }

        return new ChatResponse("Các phim thuộc thể loại " + genre + ":", movies);
    }
