...
public class ChatService {
    ...
    public handleTheaterShowtime(IntentResult.Entities e, Long userId) {
        // TO-DO
        return new ChatResponse("Chức năng này đang được phát triển. Mình sẽ thông báo khi có nhé!");
    }
