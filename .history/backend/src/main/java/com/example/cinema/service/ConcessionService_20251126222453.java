...
public class ConcessionService {
    ...
    public ConcessionService(ShowTimeRepository showtimeRepo, ConcessionItemRepository itemRepo, 
        ConcessionVariantRepository variantRepo,SeatLayoutRepository seatLayout,SeatTypeRepository seatTypeRepo,
    ...
    public ConcessionResponse loadSummary(){
        ...
        if (booking != null){
            ...
            List<Map<String, Object>> seatRows = bookingSeatRepo.findSeatByBooking(booking.get)
