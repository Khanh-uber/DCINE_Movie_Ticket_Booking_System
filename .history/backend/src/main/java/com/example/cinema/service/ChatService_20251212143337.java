...
public class ChatService {
    ...
    // 2. Nếu không có movie → LLM hỏi lại
    if (movieTitle == null || movieTitle.isBlank()) {

        String instruction = """
            Người dùng muốn xem đánh giá phim nhưng chưa nêu tên phim.
            Hãy trả lời lịch sự và yêu cầu họ cung cấp tên phim.
            Ví dụ: "Bạn muốn mình đánh giá phim nào vậy?".
        """;
    ...
    String instruction = """
        ...
        - Giữ tone thân thiện, khách quan.
