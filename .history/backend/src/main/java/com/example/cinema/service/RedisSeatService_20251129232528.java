...
public class RedisSeatService {
    ...
    // Key lưu loại vé của từng ghế
    private String typeKey(Long showtimeId, Long accountId) {
        return "hold:showtime:" + showtimeId + ":" + accountId + ":types";
    }
    
    public Set<String> getHeldSeatsForUser(Long showtimeId, Long accountId) {
        Set<String> held = redis.opsForSet().members(holdey(showtimeId, accountId));
