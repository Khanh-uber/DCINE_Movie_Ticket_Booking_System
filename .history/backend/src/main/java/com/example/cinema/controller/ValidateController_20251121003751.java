...
public class ValidateController {
    private final BookingService validateConflictService;
    private final ValidateRequest validateRequest;
    private final BookingService bookingService;
    public ValidateController(ValidateConflictService validateConflictService, ValidateRequest validateRequest, BookingService bookingService){
