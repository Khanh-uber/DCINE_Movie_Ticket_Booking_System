...
public class CheckoutService {
    ...
    // =========================================================================
    @Transactional
    public Map<String, Object> confirmCheckout(Map<String, Object> payload, Long accountId) {
        ...
        try {
            ...
            Map<String, Object> ticket = (Map<String, Object>) order.getOrDefault("ticket", new HashMap<>());
            
            // 2. Parse Ghế & Combo (Chống Null)
            ...
            long serverCalcGrand = subTotal + vat;
            
            long grandTotal = safeLong(order.get("grandTotal"));
            if(grandTotal <= 0) grandTotal = serverCalcGrand;
            long discountAmount = Math.max(0, serverCalcGrand - grandTotal);
    ...
    // =========================================================================
    @Transactional
    public Map<String, Object> markPaymentPaid(String transactionId, Long accountId) {
        try {
            Payment pm = checkoutRepo.findByTransactionId(transactionId) // <--- Sử dụng checkoutRepo
            ...
            checkoutRepo.save(pm); // <--- Sử dụng checkoutRepo
            System.out.println(">>> accountId CALLBACK = " + accountId);

            Booking booking = bookingRepo.getPendingBooking(accountId);
            System.out.println(">>> booking = " + booking);
            // Booking booking = bookingRepo.getPendingBooking(accountId);
            // if (booking != null) {
            //     booking.setTotalAmount(pm.getAmount());   // grandTotal đã lưu trong payment
            //     booking.setStatus("PAID");
            //     bookingRepo.save(booking);
            // }

            Map<String, Object> paymentData = new HashMap<>();
            paymentData.put("orderId", pm.getOrderId());
    ...
    public Map<String, Object> calculateOrderSummary(Map<String, Object> order, voucherCoder) {
