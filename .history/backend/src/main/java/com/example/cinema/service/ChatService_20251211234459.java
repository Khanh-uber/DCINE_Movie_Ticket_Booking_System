...
public class ChatService {
    ...
    private ChatResponse handleNowShowing(){
        ...
        String reply = replyService.reply(
            "hoi_phim_dang_chieu",
            context,
            "Hãy trả lời thật tự nhiên và thân thiện,ngắn gọn khoảng 2 dòng nói rằng hiện tại rạp đang có nhiều phim đang chiếu.\r\n" + //
                                "Không được liệt kê tên phim hoặc mô tả chi tiết phim, vì danh sách sẽ được hiển thị phía dưới giao diện.\r\n" + //
                                "Chỉ tạo phần mở đầu mượt mà, mang giọng vui vẻ, genz."
        );
