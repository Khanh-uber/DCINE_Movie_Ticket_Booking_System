...
public class ConcessionService {
    ...
    ,SeatLayoutRepository seatLayoutRepo,SeatTypeRepository seatTypeRepo,
            ...
            ,BookingConcessionRepository bookingConcessionRepo,ConcessionItemRepository concessionItemRepo,BookingService bookingService){
    ...
    private void calculateFinalTotalWithoutDiscount(Long bookingId) {
    ...
    public ConcessionResponse loadSummary(){
        ...
        if (booking != null){
            ...
            List<ConcessionResponse.SeatItems> Items = new ArrayList<>();
    ...
    public ConcessionResponse updateCart(ConcessionCartRequest req){
        ...
        if (req != null && req.getItems() != null) {
            for(ConcessionCartRequest.CartItem it : req.getItems()){
                ...
                dto.setVariantLabel((String) variantRow.get("label"));
        ...
        res.setTotals(totals);
        bookingService.calculateFinalTotalWithoutDiscount(bookingId);  
        return res;
}
}
