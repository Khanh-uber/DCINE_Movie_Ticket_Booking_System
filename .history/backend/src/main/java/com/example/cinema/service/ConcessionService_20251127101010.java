...
public class ConcessionService {
    ...
    private final ConcessionVariantRepository concessionVar
    ...
    ,SeatLayoutRepository seatLayoutRepo,SeatTypeRepository seatTypeRepo,
                BookingRepository bookingRepo, BookingSeatRepository bookingSeatRepo ,ConcessionItemRepository concessionRepo){
    ...
    public ConcessionMeruRespose getMenu(){
        ...
        for (ConcessionItem c : combos){
            ...
            // variants 
            List<ConcessionVariant> vList = ConcessionVariantRepo.get
        }
    }   
