...
public class ChatService {
    ...
    public ChatResponse handleFullShowtime(IntentResult.Entities e, Long userId) {
        // TO-DO
        return new ChatResponse("Chức năng này đang được phát triển. Vui lòng thử lại sau!");
    }
