...
public class ChatService {
    ...
    public ChatService(LLMService llmService, ShowtimeService showtimeService, MovieService movieService, ReplyHelper replyHHelper, LLMReplyService replyService, MovieLookupService movieLookupService) {
    ...
    private ChatResponse handleReview(IntentResult.Entities e) {
        ...
        String instruction = """
            ...
            Hãy trả lời thân thiện, gần gũi:
            - Nhắc nhẹ rằng bạn cần tên phim để đánh giá.
            - Đùa nhẹ 1 câu cho tự nhiên.
        """;
        ...
        MovieDTO movie = movieService.findByTitle(movieTitle);
        ...
        if (movie == null) {
            ...
            String instruction = """
                ...
                - Xin lỗi vì không tìm thấy phim đó.
        ...
        String context;
        try {
            context = objectMapper.writeValueAsString(movie);
        } catch (Exception ex) {
            context = "{}";
        }
        ...
        String instruction = """
            Dựa trên dữ liệu phim trong context:
            - Tóm tắt đánh giá phim bằng 2–3 câu.
            - Giữ tone thân thiện, đùa giỡn, joking một chút.x
            - KHÔNG được bịa chi tiết ngoài context.
            - Nếu có rating → nói nhẹ nhàng.
            - Nếu phim nổi tiếng → gợi ý người dùng xem trailer.
        """;
        ...
        return new ChatResponse(reply, movie);
    }
