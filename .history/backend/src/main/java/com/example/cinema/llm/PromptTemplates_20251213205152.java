...
8. hoi_gio_theo_rap → hỏi suất chiếu theo rạp
...
TIME: 
    - Nếu người dùng nói thời gian theo BUỔI (sáng, trưa, chiều, tối, khuya)
    → gán giá trị buổi đó vào entity time (giữ nguyên văn).
    - Nếu người dùng nói GIỜ CỤ THỂ (8h, 8 giờ, 21h, 21:00, 9 rưỡi)
    → chuẩn hoá về định dạng HH:mm (24h)
    → gán vào entity time.
    ...
    - Không gán giá trị mặc định cho entity time.
