...
public class ChatService {
    ...
    public ChatService(LLMService llmService, ShowtimeService showtimeService, MovieService movieService, ReplyHelper replyHelper, LLMReplyService replyService, MovieLookupService movieLookupService,
        DateParserService dateParserService, TheaterLookupService theaterLookupService, FormatShowtimes formatShowtimes) {
    ...
    return new ChatResponse(reply, null);
        ...
        if (showtimes == null || showtimes.isEmpty()) {
            ...
            String instruction = """
                Không có suất chiếu nào ở rạp và ngày người dùng yêu cầu.
                Hãy trả lời thân thiện:
                - Xin lỗi vì không có suất chiếu.
                - Gợi ý người dùng xem ngày khác hoặc chọn rạp khác.
            """;
