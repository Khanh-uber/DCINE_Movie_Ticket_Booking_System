...
public class SeatMapResponse {
    ...
    public SeatMapResponse(Map<String,PricingDTO> pricing,Long showtimeId, Long hallId, String hallName, LayoutDTO layout,List<SeatDTO> seats, List<String> booked, List<String> pending){
