...
- Các từ chỉ buổi gồm: sáng, trưa, chiều, tối, khuya.
- Nếu câu hỏi chứa từ chỉ buổi (sáng / trưa / chiều / tối / khuya)
  thì BẮT BUỘC phải gán entity time bằng từ chỉ buổi đó,
  kể cả khi từ đó đi kèm với ngày.
- Nếu người dùng nói các cụm:
  "sáng mai", "tối mai", "chiều hôm nay", "khuya ngày mai"
  thì PHẢI tách:
  - time = phần buổi (sáng / chiều / tối / khuya)
  - date = phần ngày (nay / mai / hôm nay / ngày mai)
- Không được gán toàn bộ cụm "tối mai", "sáng mai" vào date.
- Nếu người dùng nói giờ cụ thể (8h, 21h, 21:00, 9 rưỡi)
  thì chuẩn hoá về HH:mm (24h) và gán vào time.

- Nếu câu hỏi có cả buổi và giờ cụ thể
  thì ưu tiên giờ cụ thể cho time.
