...
public class ShowtimeDetailService {
    ...
    public ShowtimeDetailResponse getShowtimeDetail(Long id){
        ...
        res.setTheaterName(theaterName);
        ...
        for (Map<String, Object> row : price){
            ...
            Integer child = code.toLowerCase().equals("couple") ? null : (int) Math.round(adult * 0.8); // ghe couple khong co gia tr em
            
            zonePrices.put(code.toLowerCase(), new ShowtimeDetailResponse.Price(adult, child));
        }
