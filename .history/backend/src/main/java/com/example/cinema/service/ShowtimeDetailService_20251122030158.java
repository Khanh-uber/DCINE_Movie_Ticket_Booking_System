...
public class ShowtimeDetailService {
    ...
    public ShowtimeDetailResponse getShowtimeDetail(Long id){
        ...
        mvDto.setId(((Number) mvMap.get("movie_id")).longValue());
        mvDto.setTitle((String) mvMap.get("title"));
        mvDto.setPosterUrl((String) mvMap.get("poster_url"));
        mvDto.setTrailerUrl((String) mvMap.get("trailer_url"));
        mvDto.setReleaseDate(String.valueOf(mvMap.get("release_date")));
        mvDto.setDuration((Integer) mvMap.get("duration_min"));
        mvDto.setGenres(genres);


        ShowtimeDetailResponse.TheaterInfo thDto = new ShowtimeDetailResponse.TheaterInfo();
        thDto.setId(((Number) mvMap.get("theater_id")).longValue());
        thDto.setName((String) st.get("theater_name"));
    }
}
