...
KHÔNG được chọn hoi_danh_gia nếu câu hỏi liên quan đến:
- lịch chiếu
- thời gian chiếu
- rạp chiếu
- ngày chiếu
...
==========================
    ...
    4) Nếu câu hỏi có chứa từ "chiếu"
      VÀ có entity date hoặc time
      → intent = "hoi_lich_chieu"
      (KỂ CẢ khi câu có từ "thế nào", "ra sao")

    5) Chỉ chọn "hoi_danh_gia" khi:
      - KHÔNG có từ "chiếu"
      - KHÔNG có date, time, theater
      - Câu hỏi chỉ nói về chất lượng phim

    3) Tuyệt đối KHÔNG chọn "hoi_danh_gia" nếu câu hỏi liên quan đến:
      - lịch chiếu
      - thời gian chiếu
      - rạp chiếu
